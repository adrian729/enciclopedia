...
**Generated lesson:** [Week 1](german/week_1.md)
...
**Generated lesson:** [Week 2](german/week_2.md)
...
**Goal:** Narrate in the simple past using Präteritum for sein/haben/modals and 20 high-frequency strong verbs, use reflexive verbs with accusative and dative pronouns, apply all three adjective declension types (weak/mixed/strong) across nominative, accusative & dative, and use indefinite pronouns. (The genitive case itself isn't introduced until Week 4 — genitive adjective endings are added there once the case is taught, completing the four-case picture.)

**Generated lesson:** [Week 3](german/week_3.md)
...
> 4. **Adjective Declension — Nominative, Accusative & Dative, All Types** — Weak endings after der-words (3×4 table: Nom/Acc/Dat × Masc/Fem/Neut/Pl; pattern: -e in Nom + Fem/Neut Acc, -en everywhere else), mixed endings after ein-words (3×4 table; key difference: Nom Masc -er, Nom/Acc Neut -es), strong endings without article (3×4 table; full case signals), the signal concept summarized (decision tree), and 10 worked examples (3 each for weak/strong, 4 for mixed to contrast both its Nom masc -er and Nom/Acc neut -es signal endings, showing decision process step by step). Genitive is deliberately excluded here — the case itself isn't taught until Week 4; Week 4 extends these same three tables with a Genitive row once the case is introduced.
> 5. **Vocabulary Expansion (200 New Words → 500 Cumulative)** — Thematic groups: Feelings & Emotions (25), Health & Body (25), Weather (20), Hobbies & Free Time (25), Travel & Directions (25), Colors & Shapes (20), Food & Cooking Expansion (25), Extended Family Vocabulary (25), and Word Formation: Verb → Noun patterns (spielen → das Spiel — 10 pairs).
...
> 1. **Genitive Case — Possession & Attribution** — Genitive article forms (des, der, des, der / eines, einer, eines — full chart), masculine & neuter nouns add -(e)s in genitive (rules for -es vs. -s), genitive for possession (6 examples), genitive with proper names (Annas Buch — apostrophe only after -s/-x/-z: Thomas' Buch), genitive prepositions (wegen, trotz, während, statt/anstatt, innerhalb, außerhalb — 6 examples), a complete four-case article table (Nom/Acc/Dat/Gen × Masc/Fem/Neut/Pl — definite, indefinite, and possessive articles), and the genitive row completing Week 3's weak/mixed/strong adjective declension tables (weak -en, mixed -en, strong -en for masc/neut and -er for fem/pl — 4 worked examples, one per type plus a mixed-context check).
...
> 4. **Vocabulary Expansion (200 New Words → 700 Cumulative)** — Thematic groups: City & Directions (25), Clothing & Appearance (25), Describing People (25), Nature & Animals (25), Housing & Living Situation (30), Body Care & Personal Hygiene (30), Common Adjectives: Opposites Expansion (30), and Word Formation: Adjective → Noun with -heit/-keit (schön→die Schönheit, möglich→die Möglichkeit — 10 pairs).
...
> 1. **Separable Prefix Verbs** — List separable prefixes (ab-, an-, auf-, aus-, ein-, mit-, vor-, zu-, zurück-, weg-, her-, hin-), separable verbs in Präsens with prefix at end (5 examples), Präteritum with prefix at end (stand ... auf, kam ... an, machte ... auf — 5 examples, reusing Week 3's Präteritum forms), Perfekt with ge- between prefix and stem (aufgestanden, angefangen, mitgenommen, eingekauft, zugehört — 10 Partizip II forms), separable verbs in subordinate clauses where prefix reunites — shown in Präsens, Präteritum, and Perfekt (4 examples each), and a table of 20 high-frequency separable verbs (aufstehen, anfangen, aufhören, ankommen, aufmachen, zumachen, einkaufen, mitnehmen, zurückkommen, ausgehen, einladen, anrufen, aufräumen, umziehen, abfahren, einschlafen, vorstellen, vorbereiten, teilnehmen, stattfinden).
...
> 2. **Verbs with Fixed Prepositions** — 13 verb + accusative preposition combos (warten auf, sich freuen auf, denken an, sich gewöhnen an, sich interessieren für, bitten um, sich bewerben um, sich kümmern um, achten auf, reagieren auf, verzichten auf, glauben an, sprechen über), 11 verb + dative preposition combos (Angst haben vor, gehören zu, träumen von, sprechen mit, teilnehmen an, leiden unter, sich beschäftigen mit, sich erkundigen nach, bestehen aus, abhängen von, warnen vor), da-compounds for things/clauses (darauf, daran, dafür, davon, darüber, damit, davor, dazu — 8 examples), wo-compounds in questions (worauf, woran, wofür, wovon, worüber — 5 Q&A pairs), and da-/wo- vs. preposition + pronoun for people (4 contrastive pairs).
...
> 6. **Vocabulary Expansion (400 New Words → 2,500 Cumulative)** — Thematic groups: Law & Justice (30), Business & Commerce (30), Formal Correspondence (25 phrases), Common Idioms (25 idioms: die Daumen drücken, den Nagel auf den Kopf treffen, etc.), Science & Technology Advanced (40), Philosophy & Ethics (40), International Politics & Diplomacy (40), Healthcare Systems & Public Policy (40), Arts, Aesthetics & Criticism (40), Social Sciences & Psychology (40), Environmental Policy & Sustainability (40), and Word Formation: Partizip I/II as established adjectives (anstrengend, überraschend, begeistert, enttäuscht — 10 examples).
...
> 3. **Nominalstil — Nominal Style for Formal Register** — What Nominalstil is (converting verbal phrases to noun phrases for formal/academic text), common nominalization suffixes (-ung, -heit/-keit, -schaft, -nis, -tum — 15 examples with gender rules: -ung/-heit/-keit/-schaft = feminine [no exceptions]; -nis and -tum have **no** reliable gender rule and must be memorized per word — -nis splits neuter/feminine [das Ergebnis, das Geheimnis vs. die Kenntnis, die Erlaubnis, die Erkenntnis, die Wildnis], -tum is mostly neuter with common masculine exceptions [der Reichtum, der Irrtum vs. das Eigentum, das Christentum]; flag both as exception categories, not rules), converting verbal → nominal phrases (8 conversion pairs), genitive chains in Nominalstil (4 examples of increasing complexity), converting nominal → verbal phrases (6 pairs), and when to use which register (4 context examples).
> 4. **Vocabulary Expansion (400 New Words → 2,900 Cumulative)** — Thematic groups: Academic Writing (40 — die These, die Hypothese, belegen, widerlegen, etc.), Nuanced Synonyms (30 synonym groups — sagen: behaupten/meinen/betonen/erklären/hinzufügen), Collocations for Formal Writing (30 phrases — in Betracht ziehen, zum Ausdruck bringen, etc.), Nominalized Vocabulary (20 noun-verb pairs), Scientific & Technical Terminology (40), Legal & Administrative Language (40), Philosophy of Language & Rhetoric (40), Literary Analysis & Criticism Vocabulary (40), Business & Economic Analysis (40), Media & Discourse Analysis (40), and Diplomatic & Formal Register Expansion (40).
...
> 9. **Vocabulary Expansion (400 New Words → 3,300 Cumulative)** — Thematic groups: Advanced Idioms & Proverbs (30 items with literal + figurative meaning), Register Variation (20 formal/informal pairs: anfragen/fragen, sich befinden/sein, etc.), False Friends (20 German-English pairs: bekommen≠become, Gift≠gift, etc.), Academic & Professional (25 words), Comprehensive Review: Society & Culture (60), Comprehensive Review: Science & Environment (60), Comprehensive Review: Politics & Economy (60), Comprehensive Review: Arts & Media (60), Comprehensive Review: Personal & Professional Life (65), and Supplementary Learning Recommendations (graded readers B1-B2, Anki decks, podcasts, news sources).
> 10. **Answer Key & Model Texts** — For all exercises in section 7 (Integrated Production Exercises).
